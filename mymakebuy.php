	...
	<body>
		<header>
			...
			<div class="hero-text-box">
				<h1>Welcome to makebuy. <br> We are intermediate service.</h1>
		...
		<section class= "section-steps" id="works">
			...
			<div class="row">
				<div class="col span-1-of-2 steps-box">
					<img src="resource/img/app-iPhone.png" alt="Omnifood app on iPhone" class="app-screen js--wp-2">
				</div>
				<div class="col span-1-of-2 steps-box">
					...
					<div class="store-link">
						<a href="#" class="btn-app"><img src="resource/img/download-app.svg" alt="App Store Button"></a>
						<a href="#" class="btn-app"><img src="resource/img/download-app-android.png" alt="PlayStore Button"></a>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="section-cities js--wp-3" id="cities">
			...
			<div class= "row">
				...
				<div class="col span-1-of-4 box">
					<img src="resource/img/san-francisco.jpg" alt="Lisbon">
					<h3>San francisco</h3>
					<div class="city-feature">
						<i class="ion-ios-person icon-small"></i>
						3700+ happy eaters
				...
				<div class="col span-1-of-4 box">
					<img src="resource/img/berlin.jpg" alt="Lisbon">
					<h3>berlin</h3>
					<div class="city-feature">
						<i class="ion-ios-person icon-small"></i>
						2300+ happy eaters
				...
				<div class="col span-1-of-4 box">
					<img src="resource/img/london.jpg" alt="Lisbon">
					<h3>london</h3>
					<div class="city-feature">
						<i class="ion-ios-person icon-small"></i>
						1200+ happy eaters
			...
			<div class="row">
				<div class="col span-1-of-3">
					<blockquote>
						...
						<cite><img src="resource/img/customer-1.jpg" alt="Customer 1 photo"> Alberto Duncan</cite>
					</blockquote>
				</div>
				<div class="col span-1-of-3">
					<blockquote>
						Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
						<cite><img src="resource/img/customer-2.jpg" alt="Customer 2 photo"> Joana Silva</cite>
					</blockquote>
				</div>
				<div class="col span-1-of-3">
					<blockquote>
						I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
						<cite><img src="resource/img/customer-3.jpg" alt="Customer 3 photo"> Milton Chapman</cite>
					</blockquote>
				</div>
			</div>
		</section>
			...
			<div class="row">
				<div class="col span-1-of-3">
					<div class="plan-box js--wp-4">
						...
						<div>
							<ul>
								<li><i class="ion-ios-checkmark-empty icon-small"></i>1 meal 10 day</li>
		...
		<section class="section-form">
			...
			<div class="row">
				<form method="post" action="process/mailer.php" class="contact-form">
					<div class="row">
						<div class="col span-1-of-3">
